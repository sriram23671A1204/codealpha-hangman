...
class hangman:
    ...
    word_list = ['computer','science','artifical','intelligence','system','machine','learning','errors','python','bugs','goals','execution','exception','desktop','monitor','delete','homogeneous','number','overall','retrival','node','association','radiation','segment','autonomy','principle','calling','nearest','function','calling','prompt','sensor','laptop','mobile','critical','temporary']
